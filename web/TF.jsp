...
<div id="center" style="float:right;width:80%;height:80%;margin-top: 5%">
    ...
    <img src="images/TF.jpg" style="width:400px;height:400px;">
    <div id="right" style="float:right; width:50%;margin-right:15%;">
        <div id="up">
            <h2 name="goods.name">汤姆福特新品细管口红润唇膏</h2>
            <p name="goods.price">价格：329.00</p>
            <p>Tom Ford汤姆福特 TF口红18年TF白管黑管新品细管口红润唇膏3g 16#SCARLET ROUGE
                【满99元减5元，满189元减10元】新品细管口红唇膏</p>
        </div>
        <a href="addlike.action?goods.id=07" class="like" name="like">收藏</a>
