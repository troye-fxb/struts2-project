...
<div id="center" style="float:right;width:80%;height:80%;margin-top: 5%">
    ...
    <img src="images/tz.jpg" style="width:400px;height:400px;">
    <div id="right" style="float:right; width:50%;margin-right:15%;">
        <div id="up">
            <h2 name="goods.name">透真气色唇膏</h2>
            <p name="goods.price">价格：49.90</p>
            <p>透真气色唇膏丝柔口红笔不脱色保湿滋润雾面哑光口红不掉色 防水持久保湿滋润哑光雾面豆沙 橘红色
                保湿滋润雾面哑光口红不掉色</p>
        </div>
        <a href="addlike.action?goods.id=08" class="like" name="like">收藏</a>
